...
<head>
    ...
    {{-- Incluir Vite para cargar los estilos de Tailwind --}}
...
<body>
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <a href="#" class="text-center text-gray-700 hover:text-primary transition relative">
                    ...
                    <div class="text-xs leading-3">Lista de deseos</div>
                </a>
            ...
            <div class="px-8 py-4 bg-primary md:flex items-center cursor-pointer relative group hidden">
                ...
                <div
                    ...
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        {{-- <img src="assets/images/icons/sofa.svg" alt="sofa" > --}}
                        <img src="{{ asset('img/img_logo.png') }}" alt="img_logo" class="w-5 h-5 object-contain">
    ...
    <div class="container py-16">
        <div class="w-10/12 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto justify-center">
            <div class="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src="{{ asset('img/img_logo.png') }}" alt="Delivery" class="w-12 h-12 object-contain">
    ...
    <div class="container py-16">
        ...
        <div class="grid grid-cols-3 gap-3">
            <div class="relative rounded-sm overflow-hidden group">
                <img src="{{ asset('img/img_logo.png') }}" alt="category 1" class="w-full">
                <a href="#"
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('img/img_logo.png') }}" alt="product 1" class="w-full">
    ...
    <div class="container pb-16">
        <a href="#">
            <img src="{{ asset('img/img_logo.png') }}" alt="ads" class="w-full">
        </a>
    </div>
    <!-- ./ads -->
    ...
    <footer class="bg-white pt-16 pb-12 border-t border-gray-100">
        <div class="container grid grid-cols-1 ">
            <div class="col-span-1 space-y-4">
                <img src="{{ asset('img/img_logo.png') }}" alt="logo" class="w-30">
                <div class="mr-2">
    ...
    <div class="bg-gray-800 py-4">
        <div class="container flex items-center justify-between">
            ...
            <div>
                <img src="{{ asset('img/logo.png') }}" alt="methods" class="h-5">
            </div>
        </div>
    </div>
</body>
